        ...
        <section id="availability">
            ...
            <div className="sub-cal-buttons">
                <div className="booking-button">
                    <p>
                        <Link href="https://harmonyhill.reserveonline.id/book/1245" target="_blank" rel="noopener">Book now! &hearts;</Link>
                    </p>
                </div>
                <div className="booking-button">
                    <p>
                        <Link href="https://wa.me/message/TVA3I5GFI5VLO1" target="_blank" className="social-med-icons" aria-label="WhatsApp link">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" height="35" fill="#fff">
                                <path
